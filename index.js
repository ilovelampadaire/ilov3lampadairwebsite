...
function aboutWindow(){
	imageWindow("https://cdn.discordapp.com/avatars/1056952213056004118/81b3a4b0ff97199c14b093cb1bac7d4e?size=1024","80vw","10rem","10vw","about me","<p>Hi! My name's ilovelampadaire. I'm french, i make YouTube videos and i like programming.</p><p>I use HTML, CSS, and JavaScript for web development, and also Python for anything else.</p><p>I use VS Code, Sublime Text, and Atom as my text editors.</p><p>This website has been inspired by <a onclick=\"linkWindow('https://noxyyk.me/')\">Noxyyk</a> and got better thanks to help from <a onclick=\"linkWindow('https://ponali.github.io/')\">Ponali</a>.</p><p>My website email is: <a href=mailto:owner@ilovelampadaire.com>owner@ilovelampadaire.com</a> if you are wondering.</p>");
}
